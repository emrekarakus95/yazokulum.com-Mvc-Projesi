        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Hesap onaylamayı etkinleştirme ve parola sıfırlama hakkında daha fazla bilgi için lütfen http://go.microsoft.com/fwlink/?LinkID=320771 sayfasını ziyaret edin
